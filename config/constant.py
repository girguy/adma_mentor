...
MENTEE_DF_COLUMNS_1 = [
    ...
    MENTEE_QUESTION_12, REMARQUE, INTERVIEWER
    ]

MENTEE_DF_COLUMNS_2 = [
    'first_name','last_name','datetime','submitted_datetime','age','email','nationality', 'origine','postal_code',
    'town','question_1','question_2','question_3','question_4', 'question_5','question_6','question_7','question_8',
    'question_9','question_10', 'question_11','question_12','remarque','interviewer'
]
...
MENTOR_DF_COLUMNS_1 = [
    ...
    DATETIME, SUBMITTED_DATETIME, MENTOR_QUESTION_1, MENTOR_QUESTION_2, MENTOR_QUESTION_3,
    MENTOR_QUESTION_4, MENTOR_QUESTION_5, MENTOR_QUESTION_6, MENTOR_QUESTION_7,
    MENTOR_QUESTION_8, MENTOR_QUESTION_9, MENTOR_QUESTION_10, MENTOR_QUESTION_11,
    MENTOR_QUESTION_12, MENTOR_QUESTION_13, MENTOR_QUESTION_14, REMARQUE, INTERVIEWER,
    DOMAIN, RESIDENCE, PROFESSION, UNIVERSITY,
    ]

MENTOR_DF_COLUMNS_2 = [
    'first_name', 'last_name', 'age', 'email',
    'datetime', 'submitted_datetime', 'question_1', 'question_2', 'question_3', 'question_4',
    'question_5', 'question_6', 'question_7', 'question_8', 'question_9', 'question_10',
    'question_11', 'question_12', 'question_13', 'question_14', 'remarque', 'interviewer',
    'domain', 'residence', 'profession', 'university',
]